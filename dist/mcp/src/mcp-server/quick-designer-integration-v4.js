...
exports.QuickDesignerV4 = exports.PatternRemixService = void 0;
...
const pattern_library_js_1 = require('./pattern-library.js');
/**
...
class PatternRemixService {
  ...
  loadPatterns() {
    ...
    for (const screenType of screenTypes) {
      this.patterns.set(screenType, (0, pattern_library_js_1.getPatternsForScreen)(screenType));
    }
  }
  /**
   * Generate HTML using pattern remix approach
   */
  async generate(screenType, designSpec, style = 'modern', variationIndex = 0) {
    ...
    const pattern = (0, pattern_library_js_1.selectPatternByStyle)(patterns, style, variationIndex);
    // Apply design system to pattern
    const html = (0, pattern_library_js_1.applyDesignSystem)(pattern.html, designSpec);
    return html;
  }
  /**
   * Generate multiple variations
   */
  async generateVariations(screenType, designSpec, count = 3) {
...
exports.PatternRemixService = PatternRemixService;
/**
 ...
 */
function getVariationName(screenType, index) {
  const names = {
      ...
      <div class="tabs" id="tabs">
        ${pages
          ...
          <div class="tab ${index === 0 ? 'active' : ''}"
            ...
            ${page.name}
            ${page.variations?.some((v) => v.validated) ? '<span class="tab-badge">✓</span>' : ''}
          </div>`,
          )
          .join('')}
      </div>
...
exports.QuickDesignerV4 = {
  ...
  extractFromURL: design_extractor_js_1.extractFromURL,
...
exports.default = exports.QuickDesignerV4;
