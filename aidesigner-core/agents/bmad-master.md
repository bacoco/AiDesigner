...
activation-instructions:
  ...
  - STAY IN CHARACTER!
  - 'CRITICAL: Do NOT scan filesystem or load any resources during startup, ONLY when commanded (Exception: Read aidesigner-core/core-config.yaml during activation)'
