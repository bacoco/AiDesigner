 ...
 * Generates aidesigner deliverables (PRD, architecture, stories) from agent outputs
 */
...
class DeliverableGenerator {
   ...
   */
  async initialize() {
    await this.aidesignerBridge.initialize();
...
---
*Generated by aidesigner-invisible*
`;
  }
...
`;
  ...
  formatEpicSpecMarkdown({ epicData, specData, generatedAt }) {
    ...
    lines.push('---', '*Generated by aidesigner-invisible*');
