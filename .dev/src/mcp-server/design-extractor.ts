 ...
 */
export async function extractFromURL(url: string, chromeMCP?: any): Promise<ExtractedDesign> {
 ...
 */
export function extractFromHTML(html: string, css?: string): ExtractedDesign {
 ...
 */
function identifyComponents(html: string): ComponentLibrary {
 ...
 */
export function normalizeDesignSystem(rawData: any): DesignSpec {
 ...
 */
export async function extractElementStyle(
  url: string,
  selector: string,
  chromeMCP?: any
): Promise<any> {
 ...
 */
export const extractDesignFromURLTool: Tool = {
 ...
 */
export const analyzeDesignFromImageTool: Tool = {
 ...
 */
export const extractComponentStyleTool: Tool = {
