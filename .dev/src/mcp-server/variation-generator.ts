...
export class VariationGenerator {
  ...
  private getLayoutApproach(index: number): string {
    const approaches = ['cards', 'sidebar', 'grid', 'minimal', 'detailed', 'split', 'masonry', 'timeline'];
    return approaches[index % approaches.length];
  }

  private generateDashboard(intent: any, ds: any, layout: string, style: string, options: any): string {
    return `<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  private generateLanding(intent: any, ds: any, layout: string, style: string, options: any): string {
    return `<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  private generateAuth(intent: any, ds: any, layout: string, style: string, options: any): string {
    return `<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  private generatePricing(intent: any, ds: any, layout: string, style: string, options: any): string {
    return `<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body>
  ...
  private generateEcommerce(intent: any, ds: any, layout: string, style: string, options: any): string {
    return this.generateGeneric(intent, ds, layout, style, options);
  }

  private generateGeneric(intent: any, ds: any, layout: string, style: string, options: any): string {
    return `<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
