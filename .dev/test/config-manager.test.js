...
const DEFAULT_SERVER_NAMES = ['aidesigner-mcp', 'chrome-devtools', 'shadcn'];
...
`;
    ...
    const orchestrator = servers.find((server) => normaliseServerName(server) === 'aidesigner-mcp');
    ...
    expect(orchestrator.args).toEqual(['aidesigner', 'mcp']);
