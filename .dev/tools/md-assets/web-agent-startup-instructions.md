...
- `==================== START: .agilai-core/folder/filename.md ====================`
- `==================== END: .agilai-core/folder/filename.md ====================`

When you need to reference a resource mentioned in your instructions:

- Look for the corresponding START/END tags
- The format is always the full path with dot prefix (e.g., `.agilai-core/personas/analyst.md`, `.agilai-core/tasks/create-story.md`)
- Legacy bundles may still reference `.agilai-core` paths. Treat them the same as `.agilai-core`.
...
- `dependencies.utils: template-format` → Look for `==================== START: .agilai-core/utils/template-format.md ====================`
- `dependencies.utils: create-story` → Look for `==================== START: .agilai-core/tasks/create-story.md ====================`
